...
public class MainActivity extends BaseActivity<Integer> implements MainViewPresenter.MainViewListener {
    ...
    public Toolbar getToolbar() {
        ...
        mToolbar.setTitle(Constant.APK_UTILITY);
...
//        mRecyclerView.setOnScrollListener(new HidingScrollListenerWithOffset() {
//            @Override
...
//        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RELOAD_APPS_REQUEST_CODE:
                ...
                break;
            case UNINSTALL_APP_REQUEST_CODE:
                if (resultCode == RESULT_OK) {
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.menu_open:
                        mPresenter.openApplication(position);
                        return true;
    ...
    public void startAppIntentForResult(Intent intent) {
        startActivityForResult(intent, UNINSTALL_APP_REQUEST_CODE);
    }
